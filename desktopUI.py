...
def view_data(record_view):
                ...
                curobj = conn.cursor()
                curobj.execute("select * from Emp_details")
...
def message_senf_fn():
       ...
       #make frame for message
        message_frame = Frame(root,bd=2,relief=SOLID)
        message_frame.place(x=300,y=0,width=1066,height=768)
            
    
        title = Label(message_frame,text="Message",font=("Broadway",20,"bold"),bg="black",fg="white")
        title.place(x=0,y=0,width=1066,height=68)


            #take data from user
            
        message_frame_title = Label(message_frame,text="Employee Detail",font=("Broadway",24,"bold"),fg="white")
        message_frame_title.place(x=0,y=95,width=1066,height=35)
           
        emp_id = Label(message_frame,text="Employee ID",font=("Arial",16,"bold"),fg="white")
        emp_id.place(x=200,y=200,width=300,height=50)
        inp_id = Entry(message_frame,text="Employee ID",font=("Arial",16,"bold"),width=25,textvariable= id_var)
        inp_id.place(x=500,y=200,width=250,height=40)

           
        message_box = Label(message_frame,text="Employee message",font=("Arial",16,"bold"),fg="white")
        message_box.place(x=200,y=300,width=300,height=50)
        
        text_box=Text(message_frame,height=10,width=50)
        text_box.place(x=500,y=300,width=300,height=300)
        # text_box.pack()
        #messahge box
        ...
        def getdata():
            ...
            print(inp)
        # message_box_for_message=messagebox()
        send_mes_button=Button(message_frame,text="send",command=getdata)
        send_mes_button.place(x=450,y=650,width=100,height=50)
...
def log_in_after():
    ...
    title = Label(root,text="EAS",font=("Broadway",32,"bold"),bg="black",fg="white")
...
dept_heading_title = Label(login_frame,text="Labour,Skill Developement and Employement Department of Gujarat",bg="white",font=("Broadway",20,"bold"),fg="black")
